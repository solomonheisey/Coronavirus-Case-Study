...
For this project, I am usingthe Johns Hopkins University Center for Systems Science and Engineering (JHU CCSE) Coronavirus repository. Below is a summary of the dataset.
...
Show below is a tree map depicting the total number of recovered cases on a per-country basis. The countries are sorted in devcending order and the percentage represents the number of people who have recovered from the virus after previously being diagnosed.
